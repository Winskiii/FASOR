...
import { SearchOutlineIconMade } from "../atoms/IconsMade";
...
export {
  ...
  TableCheckbox, TableContainer, TableFilter,
  TableFilterDate, TableHead, TableHeadCell, TableMain,
  TableMore, TableSearch, TableSorting, TableSortingCol, TableSortingRow, TableWrapper
};
